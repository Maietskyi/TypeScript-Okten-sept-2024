...
let coursesArray: CoursesArray[] = [
    ...
    },
    {
        ...
        hourDuration: 909,
        modules: ['html', 'css', 'js', 'mysql', 'mongodb', 'angular',
            'aws', 'docker', 'python core', 'python advanced']
    },
    {
        title: 'QA Complex',
        monthDuration: 4,
...
console.log(coursesArray.filter((course: CoursesArray): boolean => {
    return course.modules.some((module: string): boolean => module === 'sass')
}));

console.log(coursesArray.filter((course: CoursesArray): boolean => {
    return course.modules.some((module: string): boolean => module === 'docker')
}));
